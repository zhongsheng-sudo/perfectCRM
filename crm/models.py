...
class Customer(models.Model):
    ...
    consult_course=models.ForeignKey('Course',verbose_name='咨询课程',on_delete=models.DO_NOTHING)
    ...
    memo=models.DateTimeField(blank=True,null=True)
...
class ClassList(models.Model):
    # 班级表
    branch=models.ForeignKey('Branch',verbose_name='分校',on_delete=models.DO_NOTHING)
    ...
    contract=models.ForeignKey('ContractTemplate',blank=True,null=True,on_delete=models.DO_NOTHING)
...
class CourseRecord(models.Model):
    # 上课记录
    from_class=models.ForeignKey('ClassList',verbose_name='班级',on_delete=models.DO_NOTHING)
...
class Enrollment(models.Model):
    # 报名表
    customer=models.ForeignKey('Customer',on_delete=models.DO_NOTHING)
    enrolled_class=models.ForeignKey('ClassList',verbose_name='所报班级',on_delete=models.DO_NOTHING)
...
class Payment(models.Model):
    # 缴费记录
    customer=models.ForeignKey('Customer',on_delete=models.DO_NOTHING)
    course=models.ForeignKey('course',verbose_name='所报课程',on_delete=models.DO_NOTHING)
...
class UserProfile(AbstractBaseUser,PermissionsMixin):
    ...
    stu_account=models.ForeignKey('Customer',verbose_name='关联学员账号',blank=True,null=True,help_text='只有学员报名后方可为其创建账户',on_delete=models.DO_NOTHING)
